...
* @final-during-value@ _:present-value :rate :period :in-year-period_
* @relative-during-rate@ _:rate :in-year-period_
* @conformal-during-rate@ _:rate :in-year-period_
* @effective-during-rate@ _:relative-in-year-rate :in-year-period_
